...
const NotFound = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Page Non Trouvée - 404 | Trinity Studio</title>
        <meta name="description" content="La page que vous recherchez n'existe pas ou a été déplacée. Retournez à l'accueil de Trinity Studio pour découvrir nos services web." />
      ...
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center">
          ...
          <p className="text-xs text-muted-foreground mb-8">Oops! Page not found</p>
          <a 
            href="/" 
