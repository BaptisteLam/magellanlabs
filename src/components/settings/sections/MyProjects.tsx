    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          className="bg-[#03A5C0]/20 text-[#03A5C0] border border-[#03A5C0]/50 hover:bg-[#03A5C0]/30 rounded-[7px]"
        >
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProjects.map((project) => (
            <Card key={project.id} className="overflow-hidden hover:border-[#03A5C0]/50 transition-colors rounded-[7px]">
