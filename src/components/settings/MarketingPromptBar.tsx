...
interface MarketingPromptBarProps {
  onSubmit?: (prompt: string, files?: File[]) => void;
  disabled?: boolean;
}

export function MarketingPromptBar({ onSubmit, disabled }: MarketingPromptBarProps) {
      ...
      >
        ...
        <div className="relative">
          <Textarea
            ...
            placeholder="Créez des visuels, campagnes, posts réseaux sociaux... (ex: génère un visuel produit pour Instagram)"
