...
interface FinancePromptBarProps {
  onSubmit?: (prompt: string, files?: File[]) => void;
  disabled?: boolean;
}

export function FinancePromptBar({ onSubmit, disabled }: FinancePromptBarProps) {
      ...
      >
        ...
        <div className="relative">
          <Textarea
            ...
            placeholder="Demandez à l'IA de modifier vos finances (ex: ajoute un revenu de 500€, crée un graphique des dépenses...)"
